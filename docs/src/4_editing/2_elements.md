...
- <kbd>**SKI**</kbd>: Anzahl an SKI Patienten, welche das Personal behandeln kann.
- <kbd>**SKII**</kbd>: Anzahl an SKII und SKII Patienten, welche das Personal zusätzlich zu den SKI Patienten behandeln kann.
- <kbd>**SKIII**</kbd>: Anzahl an SKIII Patienten, welche das Personal zusätzlich zu den SKII und SKI Patienten behandeln kann.
- <kbd>**UND|ODER**</kbd>: Gibt an, ob die Behandlungskapazität für SKII und SKIII Patienten kumulativ ist (UND) oder nicht (ODER).
...
- <kbd>**Name**</kbd>: Name des Materials, welcher in der Verwaltung (z.B. Fahrzeuge, welche dieses Personal enthalten) und der Statistik angezeigt wird.
- <kbd>**Bildadresse**</kbd>: URL zu einer Bilddatei. Das Bild sollte idealerweise eine Vektorgrafik (`.svg`) mit transparentem Hintergrund sein.
- <kbd>**Höhe**</kbd>: Höhe des Bildes in Punkten, wobei 100 ca. der Höhe eines normalen Sprinter-RTWs entspricht. Die Breite wird analog skaliert.
