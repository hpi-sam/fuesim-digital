...
Innerhalb der Aufzeichnung können zudem über die entsprechenden Buttons in der unteren Menüleiste die Fenster "[Teilnehmende](4_conduction.html#teilnehmende-verwalten)", "[Transferübersicht](4_conduction.md#transfers-verwalten)" und "[Statistiken](#statistiken)" angezeigt werden. Der Inhalt dieser Fenster entspricht den entsprechenden Ansichten während einer normalen Übung, wobei sämtliche Änderungen unterbunden werden und der Inhalt für den aktuell betrachteten Zeitpunkt angezeigt wird.
