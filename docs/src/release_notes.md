...
Für die Änderungen in älteren Versionen kann das [englischsprachige Changelog](https://github.com/hpi-sam/fuesim-digital/blob/dev/CHANGELOG.md#090---2025-09-23) zu Rate gezogen werden.
