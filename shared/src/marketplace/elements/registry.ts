...
import type { measureTemplateSchema } from '../../models/measure/measures.js';
...
import { marketplaceMeasureTemplate } from './measure-template.marketplace.js';
...
export const marketplaceElements = [
    ...
    MarketplaceRegistryEntry<typeof measureTemplateSchema>,
];
