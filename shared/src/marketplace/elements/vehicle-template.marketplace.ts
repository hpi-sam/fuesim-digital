                        ...
                        (vehicle) => {
                            ...
                            for (const checker of getEditableValueCheckers(
                                ...
                                newVehicle = checker.replace({
                                    ...
                                    oldElement: existingVehicle,
                                    newElement: newVehicle,
                                    // we know this will always be a string, because
                                    // we will never pass anything else down this
                                    // eslint-disable-next-line @typescript-eslint/no-base-to-string
                                    newContent: String(changeApply.newContent),
                                });
                            }
