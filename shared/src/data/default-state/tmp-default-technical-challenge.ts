...
export namespace StateMachineTesting {
    ...
    // --- States ---
    export const patientDeadButExtinguished: StateMachineState =
    ...
    export const treatedAndExtinguished: StateMachineState =
        newTechnicalChallengeState(
    ...
    export const burnedOutAndPatientDead: StateMachineState =
        newTechnicalChallengeState(
    ...
    export const burnedOutButRescued: StateMachineState =
        newTechnicalChallengeState(
    ...
    export const onlyExtinguished: StateMachineState =
        newTechnicalChallengeState(
            'Feuer gelöscht',
            newImageProperties('/assets/blue_car_broken.png', 100, 1),
            {
    ...
    export const onlyDead: StateMachineState = newTechnicalChallengeState(
        'Patient verstorben',
    ...
    export const onlyTreated: StateMachineState = newTechnicalChallengeState(
        'Patient gerettet',
        newImageProperties('/assets/blue_car_broken_burning.png', 100, 1),
        {
    ...
    export const initialState: StateMachineState = newTechnicalChallengeState(
        'Ausgangslage',
        newImageProperties('/assets/blue_car_broken_burning.png', 100, 1),
        {
    ...
    export const sm1AccessSecured: StateMachineState =
        newTechnicalChallengeState(
            'Zugang gesichert',
            newImageProperties(
    ...
    export const sm1SecondaryCollapse: StateMachineState =
        newTechnicalChallengeState(
    ...
    export const sm1StructureUnstable: StateMachineState =
        newTechnicalChallengeState(
    ...
    export const sm2RescueSuccessful: StateMachineState =
        newTechnicalChallengeState(
            'Rettung erfolgreich',
    ...
    export const sm2PersonCritical: StateMachineState =
        newTechnicalChallengeState(
            'Person notversorgt',
    ...
    export const sm2PersonDeceased: StateMachineState =
        newTechnicalChallengeState(
            'Person verstorben',
    ...
    export const sm2PersonExtricatedConscious: StateMachineState =
        newTechnicalChallengeState(
    ...
    export const sm2PersonExtricatedUnconscious: StateMachineState =
        newTechnicalChallengeState(
    ...
    export const sm2PersonLocated: StateMachineState =
        newTechnicalChallengeState(
            'Person gefunden',
    ...
    export const sm2PersonMissing: StateMachineState =
        newTechnicalChallengeState(
            'Person vermisst',
