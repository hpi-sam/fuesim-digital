...
export class CollectionUpgradeImpactModalComponent {
    ...
    public changes!: ChangedTemplateVersion[];
    public collectionElements!: Immutable<TemplateVersion[]>;
    ...
    public selectChange(change: ChangedTemplateVersion) {
