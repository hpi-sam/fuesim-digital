...
Während einer Übung, können alle Teilnehmenden mit den jeweils für sie sichtbaren [Übungselementen](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md) interagieren.

Übungsleitende haben zusätzlich verschiedene Steuerungs- und Eingriffs-Möglichkeiten, die hier zusammengefasst sind. Die zugehörigen Fenster können größtenteils über das [Hauptmenü](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-hauptmenu) unter "Durchführung" aufgerufen werden.

## Übungssteuerung

> \[!NOTE\]\nDie Buttons für Zustandsänderungen finden Übungsleitenden in der [unteren Menüleiste](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-untere-menuleiste-nur-in-ubungsleitenden-ansicht) rechts neben dem Hauptmenü.

Übungsleitende können den [Zustand einer Übung](https://outline.jonathanweth.de./21%20Allgemeines.md#h-ubungszustande) jederzeit ändern. 
...
> \[!NOTE\]\nDie Teilnehmendenübersicht kann von Übungsleitenden im [Hauptmenü](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-hauptmenu) über "Durchführung" > "Teilnehmende" geöffnet werden. Sie wird außerdem für Übungsleitende im ["Teilnehmende Einladen"-Popup](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-einladungs-buttons) angezeigt.
...
> \[!NOTE\]\nDie Transferübersicht kann von Übungsleitenden im [Hauptmenü](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-hauptmenu) über "Durchführung" → "Transferübersicht" geöffnet werden. 

Fahrzeuge und Personal, die Teil einer Übung sind, können zu einem [Transferpunkt](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-transferpunkte) transferiert werden. Ein Transfer kann von einem anderen Transferpunkt oder einer [Alarmierungsgruppe](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-alarmierungsgruppe) ausgehen.

Fahrzeuge und Personal in diesem Zustand sind auf der Karte *nicht* sichtbar. Stattdessen läuft für sie ein versteckter Countdown bis zur Ankunft am Zieltransferpunkt. Übungsleitende haben in einem Übersichtsfenster die Möglichkeit, alle laufenden Transfers einzusehen und anzupassen.

Im Fenster "Transferübersicht" wird in einer Tabelle die Liste aller Fahrzeuge und des Personals angezeigt, die sich aktuell im Transfer befinden. Die Einträge sind nach der Reihenfolge der Transferstarts sortiert. Nach einer Spalte für den Namen des Fahrzeuges oder Personals und einer für den Startpunkt ([Transferpunkt](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-transferpunkte) oder [Alarmierungsgruppe](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-alarmierungsgruppe)) wird in einer weiteren Spalte der Zieltransferpunkt angezeigt. Durch Klick auf den aktuellen Zieltransferpunkt öffnet sich eine Auswahl, in der ein beliebiger anderer Transferpunkt als Ziel ausgewählt werden kann.
...
> \[!NOTE\]\nAlarmierungen können von Übungsleitenden im Fenster "Leitstelle" (was im [Hauptmenü](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-hauptmenu) über "Durchführung" → "Leitstelle" aufgerufen wird) getätigt werden, sowie von Übenden, die der [Leitstellenansicht](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-leistellenansicht-fur-teilnehmende) zugeordnet sind.
...
Im vereinfachten Layout gibt es ein Dropdown-Menü "Ziel auswählen", mit dem ein Transferpunkt ausgewählt werden kann. In Szenarien mit vielen [Transferpunkten](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-transferpunkte) kann über eine Textsuche nach dem gewünschten Punkt gesucht werden.

Unterhalb der Zielauswahl befinden sich Buttons für alle in der Übung verfügbaren [Alarmierungsgruppen](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-alarmierungsgruppe). Bei Alarmierungsgruppen mit begrenzter Anzahl an Auslösungen wird die Anzahl der verbleibenden Auslösungen hinter dem Namen der Alarmgruppe angezeigt. Unabhängig von eventuellen Begrenzungen wird bei jeder Gruppe, die bereits mindestens einmal alarmiert wurde, der Hinweis "(bereits alarmiert)" hinter ihrem Namen angezeigt. Wenn kein Ziel gewählt ist oder eine Auslösung aufgrund der Begrenzung nicht mehr möglich ist, wird der jeweilige Button ausgegraut.

Mit einem Klick auf den jeweiligen Button wird die entsprechende Alarmgruppe ausgelöst, was bedeutet, dass die jeweiligen [Fahrzeuge](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-fahrzeuge-mit-personal-und-material) mit den hinterlegten Zeiten in den Transfer zum ausgewählten Transferpunkt gehen.

### Komplexes Layout

Im komplexen Layout wird zunächst die [Alarmierungsgruppe](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-alarmierungsgruppe) über ein Dropdown-Menü ausgewählt und anschließend im zweiten Dropdown-Menü der [Zieltransferpunkt](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-transferpunkte).

Zusätzlich kann unter der Überschrift "Abweichendes Ziel für die ersten Fahrzeuge" eine Anzahl von Fahrzeugen ausgewählt werden, die an einem abweichenden Transferpunkt eintreffen. Sobald ein Wert größer oder gleich 1 eingegeben wurde, muss auch ein zusätzlicher [Zieltransferpunkt](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-transferpunkte) im entsprechenden Dropdown-Menü ausgewählt werden. An dieses Ziel werden dann die ersten X Fahrzeuge der Alarmgruppe geschickt.
...
> \[!NOTE\]\nDas digitale Einsatztagebuch kann von Übungsleitenden im Fenster "Leitstelle" (was im [Hauptmenü](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-hauptmenu) über "Durchführung" → "Leitstelle" aufgerufen wird) geführt werden, sowie von Übenden, die der [Leitstellenansicht](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-leistellenansicht-fur-teilnehmende) zugeordnet sind.

Das Einsatztagebuch ist ein Ort, in dem während einer Übung Notizen mit festem Zeitstempel abgespeichert werden können. Dabei wird zwischen "privaten Übungsnotizen" (die von den Übungsleitenden angelegt und gespeichert werden können) und "öffentlichen Leitstellennotizen" unterschieden. Erstes ist vorgesehen für Anmerkungen, die die Übende für die spätere Auswertung notieren wollen. Letztere Art von Notizen ist dafür gedacht, dass die Teilnehmenden in der [Leitstellenansicht](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-leistellenansicht-fur-teilnehmende) die Aufgabe erhalten, ein Einsatztagebuch aus Leitstellensicht zu führen, wodurch die Qualität der Rückmeldungen der übrigen Teilnehmenden erfasst und ausgewertet werden kann.
