...
export class OidcService {
    ...
    private readonly OIDC_RANDOM_STATE_LENGTH = 43;
    ...
    public async getAuthUrl(opts?: {
        ...
        const state =
            oidc.randomState().slice(0, this.OIDC_RANDOM_STATE_LENGTH).padEnd(this.OIDC_RANDOM_STATE_LENGTH, '=') +
            (opts?.returnTo ?? '');
    ...
    public async handleCallback(req: ExpressRequest, res: ExpressResponse) {
        ...
        const returnTo = state.length > this.OIDC_RANDOM_STATE_LENGTH ? state.slice(this.OIDC_RANDOM_STATE_LENGTH) : undefined;
