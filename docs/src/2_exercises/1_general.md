...
Um die jeweiligen PINs einfach an weitere Nutzende weiterzugeben und diese zur Übung hinzuzufügen, gibt es in einer Übung in der oberen Menüleiste die Buttons "Teilnehmende einladen" und "Übungsleitende einladen". Näheres dazu unter [Übungsansicht](2_user_interfaces.md#übungsansichtkartenansicht).
...
Übungsleitende können in der [unteren Menüleiste](2_user_interfaces.md#untere-menüleiste-nur-in-übungsleitungs-ansicht) den Punkt "Einstellungen" wählen. Es öffnet sich ein Fenster, in dem globale Einstellungen für die aktuelle Übung vorgenommen werden können.
...
Die wichtigste Einstellung ist die **Serveradresse**, die analog zur oben näher beschriebenen [Einstellung für die Übungskarte](#karte) funktioniert.
