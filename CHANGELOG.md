...
- There is a dedicated view for "interface signallers" to participate in a exercise with simulated regions. Interface signallers can request information from simulated regions on behalf of the incident command and forward instructions back to the simulated regions.
