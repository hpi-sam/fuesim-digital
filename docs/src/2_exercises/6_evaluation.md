...
![Diagramme zur Auswertung der Anzahlen in einer Ansicht](./evaluation_diagramms.png)
...
> [!NOTE]
> Mit tatsächlicher Sichtungskategorie ist die als „Musterlösung“ hinterlegte Sichtungsfarbe gemeint, die auch vom zugeordneten Personal ausgewählt wird. Eventuelle Fehlsichtungen der (menschlichen) Übenden sind nicht berücksichtigt.
...
![Statistik über die Krankenhaus-Zuweisungen und Abfahrtszeitpunkte](./evaluation_hospitals.png)
...
![Ereignisprotokoll einer Übung](./evaluation_log.png)
...
![Aufzeichnung einer Übung mit Zeitstrahl](./evaluation_replay.png)
