...
Auf der Startseite der FüSim Digital befinden sich ein Button, um [einer Übung mit einer gegebenen PIN beizutreten](https://outline.jonathanweth.de./21%20Allgemeines.md#h-einer-ubung-beitreten), und ein Button, um eine [neue Übung zu erstellen](https://outline.jonathanweth.de./21%20Allgemeines.md#h-ubungen-anlegen).

## Übungsansicht/Kartenansicht

<SCREENSHOT Teilnehmendensansicht>

<SCREENSHOT Übungsleitungsansicht>
...
Standardmäßig ist eine Satellitenkarte eingestellt. Allerdings kann der Kartenserver in den [Einstellungen](https://outline.jonathanweth.de./21%20Allgemeines.md#h-einstellungen) frei gewählt werden, und es sind auch Server ohne Satellitenbild verfügbar.
...
Dort ist insbesondere ein grauer Button mit der Beschriftung "Teilnehmende einladen" zu sehen. Klickt man auf diesen, wird in einem Popup die Teilnehmenden-PIN noch einmal in groß angezeigt, zusammen mit einem QR-Code, dessen Scannen andere Nutzende direkt zur Übung führt. Übungsleitende sehen an dieser Stelle neben PIN und QR-Code eine Liste aller Teilnehmenden und können diese [einteilen.](https://outline.jonathanweth.de./24%20Durchf%C3%BChrung.md#h-teilnehmende-verwalten)
...
Im linken Bereich der unteren Menüleiste befindet sich ein Hauptmenü für Übungsleitungen, das Zugriff auf sämtliche [Konfigurations- und Übersichtsfenster](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-konfigurations-und-ubersichtsfenster) bietet. Das Menü ist unterteilt in "Einstellungen" sowie in die drei Phasen eines typischen Übungs-Lebenszyklus: "Erstellung", „Durchführung" und "Auswertung".

#### Übungssteuerung

Rechts neben dem Hauptmenü in der unteren Menüleiste befindet sich ein blauer Button, mit dem die Übung (je nach aktuellem [Zustand](https://outline.jonathanweth.de./21%20Allgemeines.md#h-ubungszustande)) gestartet, pausiert oder fortgesetzt werden kann (siehe [Übungssteuerung](https://outline.jonathanweth.de./24%20Durchf%C3%BChrung.md#h-ubungssteuerung)). 
...
Übungsleitende sehen am rechten Rand der Karte den sogenannten "Editor". Dieser besteht aus einem Auswahlmenü mit Vorlagen für alle in der Übung platzierbaren [Übungselemente](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md). Wenn diese angeklickt und auf die Übungskarte "gezogen" werden wird basierend auf der Vorlage ein entsprechendes Übungselement entstellt.
...
* **Ansicht/Transferpunkt**: Hier befinden sich Vorlagen für [Ansichten](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-ansicht) (Bereiche einer Übung, denen ein Teilnehmender zugeordnet werden kann) und [Transferpunkte](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-transferpunkt) (verbindbare Punkte, bei denen alarmierte Kräfte eintreffen und zwischen denen Personal und Fahrzeuge transferiert werden können) platziert werden. Optional können hier die (nur für Übungsleitende sichtbaren) Verbindungslinien zwischen Transferpunkten deaktiviert werden. 
* **Simulierte Bereiche**: Mithilfe der Vorlagen "Patientenablage", "Bereitstellungsraum" oder "Transportorganisation" können vorkonfigurierte [simulierte Bereiche](https://outline.jonathanweth.de./../3%20Simulation.md) ausgewählt werden. Als letztes in der Liste steht die Vorlage für einen generischen simulierten Bereich, der manuell konfiguriert werden kann.
* **Zonen**: Es können [Zonen](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-zone) platziert werden, wobei es sich um Bereiche auf der Übungskarte handelt, die benannt, farblich markiert sowie auf eine bestimmte Anzahl und bestimmte Arten von Fahrzeugen beschränkt werden können. Die zuerst stehende Vorlage "Eingeschränkte Zone" erzeugt generische und frei konfigurierbare Zonen. Die drei anderen zur Auswahl stehenden Vorlagen sind vorkonfiguriert als mögliche "Ladezone", "Pufferzone" und "RTH-Landeplatz", können aber weiter verfeinert werden.
...
* **Fahrzeuge**: Hier kann aus den Vorlagen für [Fahrzeuge](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-fahrzeug) ausgewählt werden, wobei auch neue Vorlagen erstellt und Vorlagen bearbeitet und gelöscht werden können. Es ist zu beachten, dass Änderungen einer Vorlage sich nicht auf bereits platzierte Fahrzeuge auswirken.
* **Bilder**: Bei den [Bildern](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-bild) handelt es sich um frei platzierbare, dekorative Übungselemente. In diesem Teil des Editors befindet sich eine Liste aller Bild-Vorlagen, wobei auch neue Vorlagen erstellt und Vorlagen bearbeitet und gelöscht werden können. Sämtliche Bilder können nach dem Platzieren noch beliebig modifiziert werden. 

#### Import von Übungselementen

In der Überschrift vom Editor befindet sich ein Button zum [Import von Vorlagen](https://outline.jonathanweth.de./21%20Allgemeines.md#h-vorlagen-importieren), wobei eine `.json`-Datei mit Patienten-, Fahrzeug- oder Bildvorlagen gewählt werden kann.

### Konfigurations- und Übersichtsfenster (nur in Übungsleitenden-Ansicht)

Folgende Fenster sind über das Hauptmenü in der [unteren Menüleiste](https://outline.jonathanweth.de/doc/22-ansichten-Say3tcwyfv#h-untere-menuleiste-nur-in-ubungsleitungs-ansicht) für Übungsleitende verfügbar:

* **Einstellungen**: Hier können die allgemeinen [Übungseinstellungen](https://outline.jonathanweth.de./21%20Allgemeines.md#h-ubungseinstellungen) vorgenommen werden.
* #### Erstellung
  * **Alarmierungsgruppen**: In diesem Fenster können [Alarmierungsgruppen](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-alarmierungsgruppe) erstellt, bearbeitet und wieder gelöscht werden.
  * **Krankenhäuser**: In diesem Fenster können [Krankenhäuser](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-krankenhaus) erstellt, bearbeitet und wieder gelöscht werden.
* **Durchführung**
  * **Teilnehmende**: Fenster zur [Verwaltung der Übungsteilnehmenden](https://outline.jonathanweth.de./24%20Durchf%C3%BChrung.md#h-teilnehmerubersicht).
  * **Transferübersicht**: Fenster zur [Verwaltung von laufenden Transfers](https://outline.jonathanweth.de./24%20Durchf%C3%BChrung.md#h-transferubersicht) zwischen Transferpunkten
  * **Leitstelle**: Fenster mit allen [Leitstellenfunktionen](https://outline.jonathanweth.de./24%20Durchf%C3%BChrung.md#h-leitstelle), über das Übungsleitende Nachalarmierungen starten und ein Einsatztagebuch führen können.
  * **Simulationseinstellungen (Übungsleitung)**: Einstellungen zur [Simulation](https://outline.jonathanweth.de./../3%20Simulation.md) von Übungsbestandteilen.
  * **Simulationsübersicht (Funker)**: Schließt die Übungsansicht und öffnet stattdessen die Ansicht für [Schnittstellenfunker](https://outline.jonathanweth.de./../3%20Simulation/33%20Schnittstellenfunker.md) zur Kommunikation zwischen Teilnehmenden und simulierten Bereichen.
* **Auswertung**
  * **Statistik**: Fenster mit den [Statistiken](https://outline.jonathanweth.de./25%20Auswertung.md#h-statistik) zur aktuellen Übung. Beinhaltet auch ein detailliertes Protokoll.
  * **Aufzeichnung**: Schließt die Übungsansicht und öffnet stattdessen die Replay-Ansicht, in der die [Aufzeichnung](https://outline.jonathanweth.de./25%20Auswertung.md#h-aufzeichnung) der aktuellen Übung betrachtet werden kann.
...
In der linken Hälfte des Fensters befindet sich das [Einsatztagebuch](https://outline.jonathanweth.de./24%20Durchf%C3%BChrung.md#h-einatztagebuch). Bei kleinen Bildschirmen (z.B. einem Tablet hochkant) befindet es sich unten statt links. Hier können Einträge verfasst und mit Knopfdruck im Tagebuch gespeichert werden.  Wenn mehrere Teilnehmende in der Leitstellenansicht sind, können sie gegenseitig ihre Einträge sehen. 

### Alarmierungen

In der rechten Hälfte des Fensters befindet sich das Menü zur [Alarmierung](https://outline.jonathanweth.de./24%20Durchf%C3%BChrung.md#h-alarmierungen) weiterer Einsatzkräfte. Bei kleinen Bildschirmen (z.B. einem Tablet hochkant) befindet es sich oben statt rechts. 

In dem Menü muss zunächst ein [Transferpunkt](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-transferpunkt) als Ziel ausgewählt werden und dann eine Alarmgruppe angeklickt werden. Optional kann eine komplexe Ansicht aktiviert werden, bei der ein Teil der alarmierten Fahrzeuge zu einem abweichenden [Transferpunkt](https://outline.jonathanweth.de./23%20%C3%9Cbungselemente.md#h-transferpunkt) geschickt werden kann.
...
<SCREENSHOT Einsatzansicht Abschnitte>
