...
Übungsleitende haben zusätzlich verschiedene Steuerungs- und Eingriffs-Möglichkeiten, die hier zusammengefasst sind. Die zugehörigen Fenster können größtenteils über das [Hauptmenü](2_user_interfaces.md#hauptmenu) unter "Durchführung" aufgerufen werden.

## Übungssteuerung

> [!NOTE]
> Die Buttons für Zustandsänderungen finden Übungsleitenden in der [unteren Menüleiste](2_user_interfaces.md#untere-menuleiste-nur-in-ubungsleitenden-ansicht) rechts neben dem Hauptmenü.
...
> [!NOTE]
> Die Teilnehmendenübersicht kann von Übungsleitenden im [Hauptmenü](2_user_interfaces.md#hauptmenu) über "Durchführung" > "Teilnehmende" geöffnet werden. Sie wird außerdem für Übungsleitende im ["Teilnehmende Einladen"-Popup](2_user_interfaces.md#einladungs-buttons) angezeigt.
...
> [!NOTE]
> Die Transferübersicht kann von Übungsleitenden im [Hauptmenü](2_user_interfaces.md#hauptmenu) über "Durchführung" → "Transferübersicht" geöffnet werden. 

Fahrzeuge und Personal, die Teil einer Übung sind, können zu einem [Transferpunkt](3_exercise_elements.md#transferpunkte) transferiert werden. Ein Transfer kann von einem anderen Transferpunkt oder einer [Alarmierungsgruppe](3_exercise_elements.md#alarmierungsgruppe) ausgehen.
...
> [!NOTE]
> Alarmierungen können von Übungsleitenden im Fenster "Leitstelle" (was im [Hauptmenü](2_user_interfaces.md#hauptmenu) über "Durchführung" → "Leitstelle" aufgerufen wird) getätigt werden, sowie von Übenden, die der [Leitstellenansicht](2_user_interfaces.md#leistellenansicht-fur-teilnehmende) zugeordnet sind.
...
Unterhalb der Zielauswahl befinden sich Buttons für alle in der Übung verfügbaren [Alarmierungsgruppen](3_exercise_elements.md#alarmierungsgruppe). Bei Alarmierungsgruppen mit begrenzter Anzahl an Auslösungen wird die Anzahl der verbleibenden Auslösungen hinter dem Namen der Alarmgruppe angezeigt. Unabhängig von eventuellen Begrenzungen wird bei jeder Gruppe, die bereits mindestens einmal alarmiert wurde, der Hinweis "(bereits alarmiert)" hinter ihrem Namen angezeigt. Wenn kein Ziel gewählt ist oder eine Auslösung aufgrund der Begrenzung nicht mehr möglich ist, wird der jeweilige Button ausgegraut.
...
Im komplexen Layout wird zunächst die [Alarmierungsgruppe](3_exercise_elements.md#alarmierungsgruppe) über ein Dropdown-Menü ausgewählt und anschließend im zweiten Dropdown-Menü der [Zieltransferpunkt](3_exercise_elements.md#transferpunkte).
...
> [!NOTE]
> Das digitale Einsatztagebuch kann von Übungsleitenden im Fenster "Leitstelle" (was im [Hauptmenü](2_user_interfaces.md#hauptmenu) über "Durchführung" → "Leitstelle" aufgerufen wird) geführt werden, sowie von Übenden, die der [Leitstellenansicht](2_user_interfaces.md#leistellenansicht-fur-teilnehmende) zugeordnet sind.

Das Einsatztagebuch ist ein Ort, in dem während einer Übung Notizen mit festem Zeitstempel abgespeichert werden können. Dabei wird zwischen "privaten Übungsnotizen" (die von den Übungsleitenden angelegt und gespeichert werden können) und "öffentlichen Leitstellennotizen" unterschieden. Erstes ist vorgesehen für Anmerkungen, die die Übende für die spätere Auswertung notieren wollen. Letztere Art von Notizen ist dafür gedacht, dass die Teilnehmenden in der [Leitstellenansicht](2_user_interfaces.md#leistellenansicht-fur-teilnehmende) die Aufgabe erhalten, ein Einsatztagebuch aus Leitstellensicht zu führen, wodurch die Qualität der Rückmeldungen der übrigen Teilnehmenden erfasst und ausgewertet werden kann.
