...
>;
export const SetEvaluationEnabledActionSchema = z.strictObject({
    type: z.literal('[Configuration] Set evaluationEnabled'),
    evaluationEnabled: exerciseConfigurationSchema.shape.evaluationEnabled,
});
export type SetEvaluationEnabled = Immutable<
    z.infer<typeof SetEvaluationEnabledActionSchema>
>;
export namespace ConfigurationActionReducers {
    ...
    export const setEvaluationEnabled: ActionReducer<SetEvaluationEnabled> = {
        type: SetEvaluationEnabledActionSchema.shape.type.value,
        actionSchema: SetEvaluationEnabledActionSchema,
